  ...
  return (
    <main style={{ color: "#134e4a" }}>
      ...
      <nav className="flex items-center justify-between px-8 py-4 bg-white shadow-sm">
        ...
        <a
          href="mailto:hello@wikolabs.com?subject=HelpiqAI — Demande de démo"
      ...
      <section className="max-w-2xl mx-auto px-6 pb-16 text-center">
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-teal-100">
          <div className="text-4xl mb-4" style={{ color: "#0d9488" }}>&ldquo;</div>
          <p className="text-teal-900 text-lg leading-relaxed mb-4">
            Avant HelpiqAI, mon équipe SAV traitait 300 tickets/jour. Aujourd'hui, 80% sont résolus automatiquement. Mon équipe gère les cas complexes — et les clients sont plus satisfaits.
          </p>
          <div className="font-semibold text-teal-700">Sophie M. — Responsable SAV, boutique mode 50k clients</div>
        </div>
      </section>
