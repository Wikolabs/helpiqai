...
export const metadata: Metadata = { title: "HelpIQ , Support client IA, resolutions instantanees 24/7", description: "85% de tickets resolus automatiquement. HelpIQ automatise votre support client avec l'IA sans sacrifier la qualité." };
